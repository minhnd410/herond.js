...
import {
  ...
  SequenceUtils,
  RequireFreshSigner
} from '@herond/wallet-contracts'

const FactoryArtifact = require('@herond/wallet-contracts/artifacts/contracts/Factory.sol/Factory.json')
const GuestModuleArtifact = require('@herond/wallet-contracts/artifacts/contracts/modules/GuestModule.sol/GuestModule.json')
const MainModuleArtifact = require('@herond/wallet-contracts/artifacts/contracts/modules/MainModule.sol/MainModule.json')
const MainModuleUpgradableArtifact = require('@herond/wallet-contracts/artifacts/contracts/modules/MainModuleUpgradable.sol/MainModuleUpgradable.json')
const SequenceUtilsArtifact = require('@herond/wallet-contracts/artifacts/contracts/modules/utils/SequenceUtils.sol/SequenceUtils.json')
const RequireFreshSignerArtifact = require('@herond/wallet-contracts/artifacts/contracts/modules/utils/libs/RequireFreshSigner.sol/RequireFreshSigner.json')
