...
import { WalletConfig, addressOf, encodeSignature, DecodedFullSigner, DecodedEOASigner } from '@herond/config'
import { readSequenceNonce, sequenceTxAbiEncode, Transaction } from '@herond/transactions'
...
const MainModuleGasEstimation = require("@herond/wallet-contracts/artifacts/contracts/modules/MainModuleGasEstimation.sol/MainModuleGasEstimation.json")
