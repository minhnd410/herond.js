...
For more info see [0xsequence project page](https://github.com/minhnd410/herond.js).

Inspired by MakerDAO [Multicall.js](https://github.com/makerdao/multicall.js).

## Installation

`yarn add @herond/multicall`

or

`npm install --save @herond/multicall`
...
```ts
import { providers } from '@herond/multicall'
...
| contract   | Yes      | Instance of MultiCallUtils contract, see: https://github.com/herond/wallet-contracts/blob/master/src/contracts/modules/utils/MultiCallUtils.sol. |
