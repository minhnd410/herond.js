...
import { UniversalDeployer } from '@herond/deployer'
import { WalletContext } from '@herond/network'
import { testAccounts, getEOAWallet } from './accounts'

// TODO/NOTE: it should be possible to import below from just '@herond/wallet-contracts'
...
//
// by importing from '@herond/wallet-contracts/gen/typechain', this issue goes away
...
} from '@herond/wallet-contracts/gen/typechain'
